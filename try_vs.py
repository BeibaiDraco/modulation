...
# Enhance color neurons
responses_enhanced = responses.copy()
enhancement_factor = 3.0  # Increase response of color neurons
responses_enhanced[:, color_neurons] *= enhancement_factor
...
def create_response_visualization(responses_list, titles, shape_data, color_data):
    ...
    x_lim = [x_center - max_range/2-0.5, x_center + max_range/2+0.5]
    y_lim = [y_center - max_range/2-0.5, y_center + max_range/2+0.5]
...
conditions = [
    ...
    ('Segregated Network - Enhanced Color Neurons', responses_enhanced)
]
...
# Print analysis
print("\nNetwork Analysis:")
print(f"Number of shape-selective neurons: {len(shape_neurons)}")
print(f"Number of color-selective neurons: {len(color_neurons)}")
print(f"Enhancement factor for color neurons: {enhancement_factor}x")
print("\nShape neuron indices:", shape_neurons)
print("Color neuron indices:", color_neurons)